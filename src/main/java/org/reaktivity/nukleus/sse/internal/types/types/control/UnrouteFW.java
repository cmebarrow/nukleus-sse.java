...
public final class UnrouteFW extends Flyweight {
  ...
  public String toString() {
    return String.format("UNROUTE [correlationId=%d, role=%s, source=%s, sourceRef=%d, target=%s, targetRef=%d, authorization=%d, extension=%s]", correlationId(), role(), sourceRO.asString(), sourceRef(), targetRO.asString(), targetRef(), authorization(), extension());
  }
