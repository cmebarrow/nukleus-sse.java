...
public final class UnresolvedFW extends Flyweight {
  ...
  public static final int TYPE_ID = 0x40000012;
  ...
  @Override
  public UnresolvedFW wrap(DirectBuffer buffer, int offset, int maxLimit) {
  ...
  public String toString() {
    return String.format("UNRESOLVED [correlationId=%d]", correlationId());
  }

  public static final class Builder extends Flyweight.Builder<UnresolvedFW> {
